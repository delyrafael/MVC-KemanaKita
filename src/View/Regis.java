...
import Controller.ControllerUserRegis;
...
public class Regis extends javax.swing.JFrame {
     ...
     */
    ControllerUserRegis cb;
    public Regis() {
        initComponents();
        cb = new ControllerUserRegis(this);
        cb.registrasi();
    ...
    private void btnRegistrasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrasiActionPerformed
        ...
        try {
            ...
            query1 = "INSERT INTO user(id_user,nama_user,email_user,password_user)VALUES(NULL, '"+fullName+"', '"+email+"' , '"+Password+"')";
