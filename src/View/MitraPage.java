...
public class MitraPage extends javax.swing.JFrame {
    ...
    public MitraPage() {
        ...
        //cb.registrasi();
        //txtEmail.setText(LoginMitra.txtEmail.getText());
        cb.tampildata();  
        cb.reset();
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtDesk, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 530, 360, 60));
        ...
        getContentPane().add(txtsandi, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 440, 360, 60));

        txtNamaCafe.setEditable(false);
        txtNamaCafe.setFont(new java.awt.Font("Tahoma", 0, 70)); // NOI18N
        txtNamaCafe.setForeground(new java.awt.Color(138, 189, 145));
        ...
        getContentPane().add(txtNamaCafe, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 220, 810, 80));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/MitraKemanaKita -14 (1).png"))); // NOI18N
    ...
    public JTextField getTxtNamaCafe() {
        return txtNamaCafe;
    }

    public void setTxtNamaCafe(JTextField txtNamaCafe) {
